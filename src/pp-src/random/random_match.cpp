...
// Eigen::VectorXi random_ints(const size_t k_draws, const size_t max_n) {
//   std::vector<uint> random_idx(max_n);
...
//   Eigen::VectorXi random_idx_b(random_idx.size());
//   for (size_t i=0; i<random_idx.size(); i++){
//     random_idx_b(i) = random_idx[i];
//   }
//   return (random_idx_b);
// }
...
//   Eigen::MatrixXf data = Eigen::MatrixXf::Zeros(N_BASES, sketches.size());
